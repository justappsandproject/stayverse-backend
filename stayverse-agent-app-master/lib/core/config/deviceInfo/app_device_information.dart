...
class AppDeviceInformation implements DeviceInformation {
  ...
  static Future<AppDeviceInformation> initialize({
    ...
    try {
      ...
      BrimLogger.load(AppDeviceInformation).d(e);
      throw BrimAppException('Unable to fetch device and package information');
    }
  }
...
class _DeviceInfo {
  ...
  static Future<_DeviceInfo> initialize(
    ...
    throw BrimAppException('Expects to find a device platform');
  }
