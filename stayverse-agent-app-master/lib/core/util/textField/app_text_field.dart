...
class _AppTextFieldState extends State<AppTextField> {
  ...
  OutlineInputBorder get enabledBorder => OutlineInputBorder(
      ...
      borderSide: BorderSide(color: widget.enabledBorderColor ?? const Color(0XFFAAADB7), width: 1));

  OutlineInputBorder get focusedBorder => OutlineInputBorder(
      borderRadius: widget.borderRadius ?? BorderRadius.circular(10),
      borderSide: BorderSide(color: widget.focusedBorderColor ?? const Color(0XFFFBC036), width: 1));
  OutlineInputBorder get disableBorder => OutlineInputBorder(
      borderRadius: widget.borderRadius ?? BorderRadius.circular(10),
      borderSide: BorderSide(color: widget.disableBorderColor ?? const Color(0XFFAAADB7), width: 1));
}
