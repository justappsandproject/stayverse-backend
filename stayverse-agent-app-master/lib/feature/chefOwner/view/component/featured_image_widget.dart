...
class FeaturedImageWidget extends ConsumerWidget {
          ...
          child: CustomPaint(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: imageState["featured"] != null
                    ? DecorationImage(
                        image: FileImage(File(imageState["featured"]!.path)),
                        fit: BoxFit.cover,
                      )
                    : null,
              ),
              child: imageState["featured"] == null
                  ? Column(
                      ...
                      children: [
                        ...
                        AppBtn(
                          onPressed: () => notifier.pickFeaturedImage(),
                          semanticLabel: '',
                          borderRadius: 5,
                          expand: true,
