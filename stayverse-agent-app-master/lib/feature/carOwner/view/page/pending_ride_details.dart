...
class PendingRideDetails extends ConsumerStatefulWidget {
  static const route = '/PendingRideDetails';
  const PendingRideDetails({super.key, required this.rideDetails});
  final Booking? rideDetails;

  @override
  ConsumerState<PendingRideDetails> createState() => _PendingRideDetailsState();
}

class _PendingRideDetailsState extends ConsumerState<PendingRideDetails> {
