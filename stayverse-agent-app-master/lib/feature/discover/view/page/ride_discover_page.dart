...
import 'package:stayvers_agent/feature/discover/view/page/tabs/ride_booked_tab.dart';
import 'package:stayvers_agent/feature/discover/view/page/tabs/ride_completed_tab.dart';
import 'package:stayvers_agent/feature/discover/view/page/tabs/ride_pending_tab.dart';
import 'package:stayvers_agent/shared/app_icons.dart';
import 'package:stayvers_agent/shared/skeleton.dart';

class RideDiscoverPage extends ConsumerStatefulWidget {
  const RideDiscoverPage({super.key});

  @override
  ConsumerState<RideDiscoverPage> createState() => _RideDiscoverPageState();
}

class _RideDiscoverPageState extends ConsumerState<RideDiscoverPage>
