...
class TimelineWidget extends StatelessWidget {
  ...
  String formatFullDate(DateTime? dateTime) {
    ...
    //final date = DateTimeService.format(dateTime, format: 'd MMMM yyyy'); // e.g., 12 February 2023
    final time = DateFormat('h:mma').format(dateTime).toLowerCase();      // e.g., 11:32pm
    return time;
  }
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: isCompleted ? AppColors.primaryyellow : Colors.transparent,
                  ),
                ),
                Container(
                  height: 62,
