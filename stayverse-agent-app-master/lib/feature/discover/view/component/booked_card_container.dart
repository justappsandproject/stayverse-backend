...
class ApartmentBookedCard extends StatelessWidget {
  final Booking? acceptedAds;
  const ApartmentBookedCard({
    super.key,
    this.acceptedAds,
  });
  ...
  Widget build(BuildContext context) {
    final apartmentName =
        acceptedAds?.apartment?.apartmentName ?? 'Unnamed Apartment';
          ...
          children: [
            Container(
              ...
              child: ClipRRect(
                ...
                child: Image.network(
                  acceptedAds?.apartment?.apartmentImages?.firstOrNull ??
            ...
            Column(
              ...
              children: [
                ...
                MoneyServiceV2.formatNaira(
                        acceptedAds?.totalPrice?.toDouble() ?? 0)
                    .txt12(
