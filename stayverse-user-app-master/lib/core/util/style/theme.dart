  ...
  static ThemeData toThemeData({
    ...
    return ThemeData(
      ...
      colorScheme: ColorScheme(
        ...
        primaryContainer: colorStyle.primaryAccent.withOpacity(0.8),
        onPrimaryContainer: colorStyle.primaryContent,

        // Secondary colors
        secondary: colorStyle.secondary,
        onSecondary: colorStyle.onSecondary,
        secondaryContainer: colorStyle.secondary.withOpacity(0.8),
        onSecondaryContainer: colorStyle.onSecondary,

        // Tertiary colors
        tertiary: colorStyle.secondary.withOpacity(0.7),
        onTertiary: colorStyle.onSecondary,
        tertiaryContainer: colorStyle.secondary.withOpacity(0.6),
        ...
        surfaceTint: colorStyle.primaryAccent.withOpacity(0.1),
        ...
        outline: colorStyle.primaryAccent.withOpacity(0.4),
        outlineVariant: colorStyle.primaryAccent.withOpacity(0.2),
