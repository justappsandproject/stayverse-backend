...
class TopLocations extends StatelessWidget {
  const TopLocations(
      {super.key, required this.locations, required this.itemName});
    ...
    return Column(
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children:
                locations.map((value) => LocationItem(name: value)).toList(),
          ),
        ),
      ],
    );
...
class LocationItem extends StatelessWidget {
  ...
  const LocationItem({super.key, required this.name});
