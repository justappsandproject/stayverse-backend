...
import 'package:stayverse/feature/profile/view/uistate/profile_ui_state.dart';
...
class ProfileController extends StateNotifier<ProfileUiState>
  ...
  Future<bool> updatePassword(
   ...
   Future<void> updateNotificationPreference(bool enabled) async {
    ...
    try {
      final success = await BrimPusher.pushToken(notificationEnabled: enabled);
      if (success != null) {
    ...
    try {
      ...
      final profileFile = await ImageService.convertImagetoMultipart(profilePicture.path);
      final serverResponse =
  ...
  _isUpdatingNotification(bool isUpdatingNotification) {
    state = state.copyWith(isUpdatingNotification: isUpdatingNotification);
  }
