...
import 'package:stayverse/feature/apartmentDetails/view/uistate/booking_confrim_ui_state.dart';

class BookingPaymentController extends StateNotifier<BookingPaymentUiState>
    with CheckForServerError {
  BookingPaymentController(this._detailsNetworkService)
      : super(const BookingPaymentUiState());
...
final bookingPaymenrController =
    StateNotifierProvider<BookingPaymentController, BookingPaymentUiState>(
