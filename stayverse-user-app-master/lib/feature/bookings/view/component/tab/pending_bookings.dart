...
class PendingBookings extends ConsumerWidget {
  const PendingBookings({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final bookings = ref.watch(bookingController).pendingBookings;
    final isLoading = ref.watch(bookingController).isLoadingPending;
    ...
    return LazyLoadScrollView(
      ...
      onEndOfPage: () async {
        await ref
            ...
            .getBookings(BookingStatus.pending, loadMore: true);
      },
