...
typedef OnTap = void Function(SimpleSnackBarView snack);

typedef SnackbarStatusCallback = void Function(SnackbarStatus? status);

class SimpleSnackBarView extends StatefulWidget {
  ...
  @override
  State createState() => SimpleSnackBarViewState();

  /// Show the snack. It's call [SnackbarStatus.OPENING] state
  /// followed by [SnackbarStatus.OPEN]
  SnackbarController show() {
    return SimpleSnackBar.showSnackbar(this);
  }
}

class SimpleSnackBarViewState extends State<SimpleSnackBarView>
