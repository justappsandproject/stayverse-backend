...
import 'package:stayverse/shared/simpleSnackBar/libary/simple_snackbar_impl.dart';
import 'package:stayverse/shared/simpleSnackBar/libary/simple_snackbar_view.dart';
import 'package:stayverse/shared/simpleSnackBar/libary/util/util.dart';

class SnackbarController {
  static final _snackBarQueue = _SnackBarQueue();
  static bool get isSnackbarBeingShown => _snackBarQueue._isJobInProgress;
  final key = GlobalKey<SimpleSnackBarViewState>();

  late Animation<double> _filterBlurAnimation;
  late Animation<Color?> _filterColorAnimation;

  final SimpleSnackBarView snackbar;
