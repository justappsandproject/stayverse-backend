...
import 'package:stayverse/auth/controller/verify_code_controller.dart';
...
import 'package:stayverse/shared/count_down_widget.dart';
...
class _VerifyCodePageState extends ConsumerState<VerifyCodePage> {
  ...
  Widget build(BuildContext context) {
    return BrimSkeleton(
      isAuthSkeleton: true,
      isBusy: ref.watch(verifyCodeController.select((state) => state.isBusy)),
      body: Form(
        key: _formKey,
